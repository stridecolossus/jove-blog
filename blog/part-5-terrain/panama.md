...
Where _api_ is the user defined interface specifying the native library methods to be implemented and a `NativeMethod` is a wrapper for the resultant FFM handle.
